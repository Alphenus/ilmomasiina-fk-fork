...
define("USERNAME", "ilmo");       // Kannan k�ytt�j�nimi
define("PASSWORD", "vztm0iiWDr4u");       // Salasana
define("HOST", "localhost");  // Osoite tietokannan hostiin
define("DATABASE", "ilmodb");       // Tietokannan nimi
...
if (PEAR::isError($conn)) {
    // Vihdettu (new PEAR)->isError($conn) ::::> PEAR::isError($conn) PHP5.3:n vuoksi
    // /Alpi
